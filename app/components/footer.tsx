...
function Footer() {
  return (
    <footer className="h-64 max-sm:h-48 max-sm:48 mb-8 bg-black w-full text-[#FFF4ED]  rounded-lg flex  justify-between max-sm:flex-col py-4 max:sm=px-8 px-16 items-center gsp-4">
